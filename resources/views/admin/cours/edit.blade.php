...
<head>
    ...
    <title>Greatapp - Admin - Edit comment</title>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                    ...
                    <h1 class="text-3xl text-black pb-6">Edit cour</h1>
                ...
                <div class="w-full mt-12">
                    ...
                    action="{{ route('admin.cours.update', $cour->id) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="slug" type="text" class="form-input w-full bg-cool-gray-100 @error('slug')  border-red-500 @enderror"
                            name="slug" value="{{ old('slug') }} @isset($cour) {{ $cour->slug }} @endisset" 
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="title" type="text"
                            ...
                            value="{{ old('title') }} @isset($cour) {{ $cour->title }} @endisset" required autocomplete="title">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <textarea rows="5" 
                            ...
                            {{ old('description') }} @isset($cour) {{ $cour->description }} @endisset</textarea>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="author" type="text"
                            ...
                            value="{{ old('author') }} @isset($cour) {{ $cour->author }} @endisset" required autocomplete="author">
                    ...
                    @foreach ($tags as $tag)
                        <div>
                            ...
                            @isset($cour)
                                @if (in_array($tag->id, $cour->tags->pluck('id')->toArray()))
                                    checked
                                @endif
                            @endisset>
