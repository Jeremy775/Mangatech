...
<head>
    ...
    <title>Mangatech - Admin dashboard - Edit manga</title>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                    ...
                    <h1 class="text-3xl text-black pb-6">Edit manga</h1>
                ...
                <div class="w-full mt-12">
                    ...
                    action="{{ route('admin.mangas.update', $manga->id) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="slug" type="text" class="form-input w-full bg-cool-gray-100 @error('slug')  border-red-500 @enderror"
                            name="slug" value="{{ old('slug') }} @isset($manga) {{ $manga->slug }} @endisset" 
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="title" type="text"
                            ...
                            value="{{ old('title') }} @isset($manga) {{ $manga->title }} @endisset" required autocomplete="title">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <textarea rows="5" 
                            ...
                            dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" required autocomplete="description">
                            {{ old('description') }} @isset($manga) {{ $manga->description }} @endisset</textarea>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="author" type="text"
                            ...
                            value="{{ old('author') }} @isset($manga) {{ $manga->author }} @endisset" required autocomplete="author">
                    ...
                    @foreach ($tags as $tag)
                        <div>
                            ...
                            @isset($manga)
                                @if (in_array($tag->id, $manga->tags->pluck('id')->toArray()))
                                    checked
                                @endif
                            @endisset>
