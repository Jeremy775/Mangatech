...
<head>
    ...
    <title>Mangatech - Admin - Mangas</title>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex">
                    <h1 class="text-3xl text-black pb-6 flex-1">Tags</h1>
                    ...
                    <div class="bg-white overflow-auto">
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="text-gray-700">
                                ...
                                <tr>
                                    <td class="w-1/3 text-left font-bold py-3 px-4">{{ $tag->id }}</td>
                                    <td class="w-1/3 text-left py-3 px-4">{{ $tag->name }}</td>
                                    <td class="w-1/3 text-left py-3 px-4">{{ $tag->slug }}</td>
