...
<head>
    ...
    <title>Mangatech - Admin - Edit tag</title>
                ...
                <div class="w-full mt-12">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="slug" type="text" class="form-input w-full bg-cool-gray-100 @error('slug')  border-red-500 @enderror"
                            name="slug" value="{{ old('slug') }} @isset($tag) {{ $tag->slug }} @endisset" 
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="name" type="text"
                            ...
                            value="{{ old('name') }} @isset($tag) {{ $tag->name }} @endisset" required autocomplete="name">
